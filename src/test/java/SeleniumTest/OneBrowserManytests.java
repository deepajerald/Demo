...
public class OneBrowserManytests extends  InitialiseDriver{
	Logger log =  LogManager.getLogger(OneBrowserManytests.class.getName());
	LandingPage l;
	WebDriver driver;
	@BeforeTest
	...
	@Test
	public void checkCovidText() {
		//l = new LandingPage(driver);
		//driver.get(prop.getProperty("url"));
		Assert.assertTrue(l.getCovidText().isDisplayed());
	}
	@Test
